...
layer1_weight=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.conv1.wrapped_module.weight.csv');
...
b1=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.conv1.base_b_q.csv');
% layer2
...
layer2_weight=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.conv2.wrapped_module.weight.csv');
...
b2=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.conv2.base_b_q.csv');
% layer3
...
layer3_weight=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.conv3.wrapped_module.weight.csv');
...
b3=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.conv3.base_b_q.csv');
% layer4
...
layer4_weight=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.conv4.wrapped_module.weight.csv');
...
b4=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.conv4.base_b_q.csv');
% layer5
...
layer5_weight=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.conv5.wrapped_module.weight.csv');
...
b5=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.conv5.base_b_q.csv');
% layer6
...
layer6_weight=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.conv6.wrapped_module.weight.csv');
...
b6=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.conv6.base_b_q.csv');
%FC1
FC1_channel_num=1024;
FC1_vector_size=2048;
kernel_matrix_fc1=zeros(FC1_channel_num,FC1_vector_size,1);
fc1_weight=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.fc1.wrapped_module.weight.csv');
for i=1:FC1_channel_num
        kernel_matrix_fc1(i,:,1)=fc1_weight((i-1)*FC1_vector_size+1:i*FC1_vector_size);
end
b_fc1=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.fc1.base_b_q.csv');
%FC2
FC2_channel_num=10;
FC2_vector_size=1024;
kernel_matrix_fc2=zeros(FC2_channel_num,FC2_vector_size,1);
fc2_weight=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.fc2.wrapped_module.weight.csv');
for i=1:FC2_channel_num
        kernel_matrix_fc2(i,:,1)=fc2_weight((i-1)*FC2_vector_size+1:i*FC2_vector_size);
end
b_fc2=load('E:\matlab\VPS\model\CNN\9.13_data\weight_q\module.fc2.base_b_q.csv');

for i_file=3:20
       name=num2str(i_file-1);

test_lib=load(['E:\matlab\VPS\model\CNN\9.13_data\test_activation\test_act',name,'.csv']);
result_real_lib=load(['E:\matlab\VPS\model\CNN\9.13_data\test_result\test_res',name,'.csv']);
...
con_result1 = conv_vps_quan_4(conv1_input,kernel_matrix1,kernel_num1,kernel_size1,stride1,10,27);
[a,b,c]=size(con_result1);
parfor i1=1:c
	con_result1_bias(:,:,i1) = con_result1(:,:,i1)/(60*2.8814) +b1(i1)/4.0518;
end
...
con_result2 = conv_vps_quan_4(conv2_input,kernel_matrix2,kernel_num2,kernel_size2,stride2,8,64);
[a,b,c]=size(con_result2);
parfor i1=1:c
	con_result2_bias(:,:,i1) = con_result2(:,:,i1)/(20*6.0962)+b2(i1)/6.1117;
end
...
con_result3 = conv_vps_quan_4(conv3_input,kernel_matrix3,kernel_num3,kernel_size3,stride3,8,64);
[a,b,c]=size(con_result3);
parfor i1=1:c
	con_result3_bias(:,:,i1) = con_result3(:,:,i1)/(10*11.4611)+b3(i1)/6.3074;
end
...
%%%%%拓展结束
con_result4 = conv_vps_quan_4(conv4_input,kernel_matrix4,kernel_num4,kernel_size4,stride4,8,64);
[a,b,c]=size(con_result4);
parfor i1=1:c
	con_result4_bias(:,:,i1) = con_result4(:,:,i1)/(10*15.2738)+b4(i1)/4.8851;
end
...
%%%%%拓展结束
con_result5 = conv_vps_quan_4(conv5_input,kernel_matrix5,kernel_num5,kernel_size5,stride5,8,64);
[a,b,c]=size(con_result5);
parfor i1=1:c
	con_result5_bias(:,:,i1) = con_result5(:,:,i1)/(5*16.2360)+b5(i1)/11.0002;
end
...
%%%%%拓展结束
con_result6 = conv_vps_quan_4(conv6_input,kernel_matrix6,kernel_num6,kernel_size6,stride6,8,64);
[a,b,c]=size(con_result6);
parfor i1=1:c
	con_result6_bias(:,:,i1) = con_result6(:,:,i1)/(4*19.4886)+b6(i1)/10.8722;
end
...
parfor i=1:8
fc1_result_tmp =vcore_ad_3bit_lite(kernel_matrix_fc1(:,(i-1)*256+1:i*256),fc1_input((i-1)*256+1:i*256,:),8);
% fc1_result_tmp =kernel_matrix_fc1(:,(i-1)*256+1:i*256)*fc1_input((i-1)*256+1:i*256,:);
fc1_result=fc1_result+fc1_result_tmp;
end
fc1_result=fc1_result/(4*19.3253)+b_fc1/31.6076;
...
parfor i=1:4
fc2_result_tmp =vcore_ad_3bit_lite(kernel_matrix_fc2(:,(i-1)*256+1:i*256),fc1_result_relu((i-1)*256+1:i*256,:),8);
% fc2_result_tmp =kernel_matrix_fc2(:,(i-1)*256+1:i*256)*fc1_result_relu((i-1)*256+1:i*256,:);
fc2_result=fc2_result+fc2_result_tmp;
end
fc2_result=fc2_result/(15*13.6397)+b_fc2/5.3429;
...
result_lib_p(i_top)=tmp_max-1;
result_lib(i_file,i_top)=tmp_max-1;
end

fid=fopen(['E:\matlab\VPS\model\CNN\VPS_result\quan_4_bit\0921\result_',name,'.txt'],'w');
for i=1:fmap_num
    fprintf(fid,'%d \n',result_lib_p(i));
end
	%% 计算推断的正确率
	percent=0;
	for i=1:fmap_num
		if result_lib_p(i)==result_real_lib(i)
			percent=percent+1;
		end
	end
	percentage=100*percent/fmap_num;
	str=['The correct percentage of inferential results is ' num2str(percentage) '%.'];
	disp(str);
fclose(fid);
...
% fid= fopen('E:\matlab\VPS\model\CNN\9.13_data\result_vps_ad8_con1_mul_con2_3_128.txt','w');
% for i=1:fmap_num
% 		fprintf(fid,'%d \n',result_lib(i));
% end