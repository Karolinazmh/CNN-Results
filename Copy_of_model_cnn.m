...
con_result1 = conv_mul(conv1_input,kernel_matrix1,kernel_num1,kernel_size1,stride1 );
...
con_result2 = conv_vps_v1(conv2_input,kernel_matrix2,kernel_num2,kernel_size2,stride2,8,64);
...
con_result3 = conv_vps_v1(conv3_input,kernel_matrix3,kernel_num3,kernel_size3,stride3,8,64);
...
%%%%%拓展结束
con_result4 = conv_vps_v1(conv4_input,kernel_matrix4,kernel_num4,kernel_size4,stride4,8,64);
...
%%%%%拓展结束
con_result5 = conv_vps_v1(conv5_input,kernel_matrix5,kernel_num5,kernel_size5,stride5,8,256);
...
%%%%%拓展结束
con_result6 = conv_vps_v1(conv6_input,kernel_matrix6,kernel_num6,kernel_size6,stride6,8,256);
...
parfor i=1:8
fc1_result_tmp =vcore_ad_v2(kernel_matrix_fc1(:,(i-1)*256+1:i*256),fc1_input((i-1)*256+1:i*256,:),8);
...
parfor i=1:4
fc2_result_tmp =vcore_ad_v2(kernel_matrix_fc2(:,(i-1)*256+1:i*256),fc1_result_relu((i-1)*256+1:i*256,:),8);
...
% fid= fopen('E:\matlab\VPS\model\CNN\9.3data[0-1]\result_vps_ad8_con1_mul_con2_3_128.txt','w');
% for i=1:fmap_num
% 		fprintf(fid,'%d \n',result_lib(i));
% end